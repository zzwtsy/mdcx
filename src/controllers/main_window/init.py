...
def Init_Singal(self):
    ...
    self.Ui.pushButton_check_fc2_cookie.clicked.connect(self.pushButton_check_fc2_cookie_clicked)
    ...
    self.set_fc2_cookie.connect(self.Ui.plainTextEdit_cookie_fc2.setPlainText)
    self.set_fc2_status.connect(self.Ui.label_fc2_cookie_result.setText)
